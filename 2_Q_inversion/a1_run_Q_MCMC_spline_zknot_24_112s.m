...
Path_kernels_phv = ['./StartingModel_Kernels_Rayl_Q_112s/',param.CARDID,'/'];
% Load kernels
...
if is_save_mat
    if ~exist('./bayesian_mcmc_Qspline_zknot_112s/')
        mkdir('./bayesian_mcmc_Qspline_zknot_112s/');
    end
    outmat = ['./bayesian_mcmc_Qspline_zknot_112s/',outname,'_Nspline',num2str(Nspline),'.mat'];
