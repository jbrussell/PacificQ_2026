function [finalmod,cpre,vs_std,vp_std,rho_std] = run_surf96_inv_Rayl_Vs_Vp_Rho_dampcr_relaxbot_fxdisc(cobs,cstd,periods,startmod,discs,eps_data,eps_H,eps_J,eps_F,eps_vpvs,eps_rhovs,z_dampbot,nit,nit_recalc_c,vp_vs,rho_vs,nmode,varargin)
...
z_brks_sm = sort(discs_sm);
J00 = break_constraint(J00, z, z_brks_sm);
F00 = break_constraint(F00, z, z_brks_sm);

[J00, j0] = add_velocity_jump(J00, j0, z, dz, z_brks_sm, dv, eps_fac);

z_brks = [z_brks; z_brks_sm];
...
% J00 = break_constraint(J00, z, z(ind_cr(end)));
% F00 = break_constraint(F00, z, z(ind_cr(end)));
