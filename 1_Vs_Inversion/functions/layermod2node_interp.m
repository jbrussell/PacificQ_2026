...
if isQ
    Qp = [Qp(ilays); Qp(ilays(end)+1); Qp(ilays(end)+1:end)];
    Qs = [Qs(ilays); Qs(ilays(end)+1); Qs(ilays(end)+1:end)];
end
...
if isQ
    mod_int.Qp = interp1(mod.z(inoh2o),mod.Qp(inoh2o),zinterp_noh2o);
    mod_int.Qs = interp1(mod.z(inoh2o),mod.Qs(inoh2o),zinterp_noh2o);
end
...
if isQ
    mod_int.Qp = [mod.Qp(ih2o); mod_int.Qp];
    mod_int.Qs = [mod.Qs(ih2o); mod_int.Qs];
end
