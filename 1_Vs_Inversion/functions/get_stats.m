...
for ifld = 1:length(flds)
    ...
    % 68-confidence
    bootstrap.stats.(fld).u68 = prctile(bootstrap.models.(fld),84,2);
    bootstrap.stats.(fld).l68 = prctile(bootstrap.models.(fld),16,2);
end
...
for ifld = 1:length(flds)
    ...
    % 68-confidence
    bootstrap.stats.(fld).u68 = prctile(bootstrap.disp.(fld),84,2);
    bootstrap.stats.(fld).l68 = prctile(bootstrap.disp.(fld),16,2);
end
