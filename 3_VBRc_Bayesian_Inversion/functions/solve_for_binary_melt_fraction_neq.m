function [solution] = solve_for_binary_melt_fraction_neq(T_K,P_GPa,C_h2o_solid,D_h2o,C_co2_solid,D_co2,solidus_str,F)
...
solution.phi = F_solution;
solution.Cf_H2O = Cf_H2O;
solution.Cf_CO2 = Cf_CO2;

solution.Cs_H2O_0 = Cs_H2O; % Initial H2O concentration
solution.Cs_CO2_0 = Cs_CO2; % Initial CO2 concentration
solution.Cs_H2O = Cs_H2O; % H2O concentration left over in solid
solution.Cs_CO2 = Cs_CO2; % CO2 concentration left over in solid
solution.Cs_H2O_ppm = Cs_H2O*1e4; % H2O concentration left over in solid (ppm)
solution.Cs_CO2_ppm = Cs_CO2*1e4; % CO2 concentration left over in solid (ppm)
